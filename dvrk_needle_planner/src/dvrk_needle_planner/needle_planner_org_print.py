...
class needle_planner:
	def _init_(self):
	    ...
	    #--> grab at tail; phi_grab = -pi/2 --> grab at tip
   		print("needle arc radius = %f",needle_radius_)
		print("needle ht above tissue = %f",needle_axis_ht_)
    	...
    	print("at needle ht %f, distance from entrance to exit is %f",needle_axis_ht_,dist_entrance_to_exit_)	
	...
	def compute_needle_drive_gripper_affines(self, gripper_affines_wrt_camera):
	    ...
	    for ipose in range(0,NSAMPS_DRIVE_PLAN):
	        ...
	        #print("affine_needle_frame_wrt_camera_");
