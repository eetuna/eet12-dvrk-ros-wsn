...
class needle_planner:
	...
	def compute_needle_drive_gripper_affines(self, gripper_affines_wrt_camera):
	    ...
	    print "dphi"
	    print dphi
	    R0_needle_wrt_tissue_ = self.affine_needle_frame_wrt_tissue_.M
	    self.affine_needle_frame_wrt_tissue_.M = self.Rotx(self.psi_needle_axis_tilt_wrt_tissue_)*self.R0_needle_wrt_tissue_
	    print "affine_needle_frame_wrt_tissue_.linear()"
	    print self.affine_needle_frame_wrt_tissue_.M
	    R0_needle_wrt_tissue_ = self.affine_needle_frame_wrt_tissue_.M
	    affine_needle_frame_wrt_tissue_this_ = copy(self.affine_needle_frame_wrt_tissue_)


	    kvec_needle_Frame = posemath.toMatrix(affine_needle_frame_wrt_tissue_this_)
	    ...
	    needle_origin = affine_needle_frame_wrt_tissue_this_.p
	    print 5555
	    print self.affine_needle_frame_wrt_tissue_.p
	    affine_needle_frame_wrt_tissue_this_.p = self.Rotx(self.psi_needle_axis_tilt_wrt_tissue_)*needle_origin;
	    print "affine_needle_frame_wrt_tissue_.translation()"
	    print affine_needle_frame_wrt_tissue_this_.p
	    print self.affine_needle_frame_wrt_tissue_.p
	    if(debug_needle_print):
	    	print "affine_needle_frame_wrt_tissue_.linear()"
	    	print affine_needle_frame_wrt_tissue_this_.M

	    print "phi_insertion_", phi_insertion_
	    print "dphi", dphi
	    print "kvec_needle", kvec_needle
	    for ipose in range(0,NSAMPS_DRIVE_PLAN):
	    	print "NEEEEEEEEEEEEDLE ORIGIN", needle_origin
	        ...
	        affine_needle_frame_wrt_tissue_this_.M = self.R_needle_wrt_tissue_
	        self.affine_gripper_frame_wrt_tissue_ = affine_needle_frame_wrt_tissue_this_*self.affine_needle_frame_wrt_gripper_frame_.Inverse()
	        ...
	        if(debug_needle_print):
	        	...
	        	print affine_needle_frame_wrt_tissue_this_
	    ...
	    self.affine_needle_frame_wrt_tissue_ = affine_needle_frame_wrt_tissue_this_
