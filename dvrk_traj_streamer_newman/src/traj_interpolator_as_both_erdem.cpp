...
private:
    ...
    void dvrk_set_state(std_msgs::String state, std_msgs::String state1);
    ...
    ros::Subscriber get_robot_state_subscriber_PSM1,   get_robot_state_subscriber_PSM2, get_state_joint_current_subscriber_PSM1, get_state_joint_current_subscriber_PSM2;
    //get_position_cartesian_desired_suscriber,
    //get_state_joint_current_subscriber_PSM1, get_state_joint_current_subscriber_PSM2; get_position_cartesian_current_subscriber, get_goal_reached_subsriber,get_state_joint_desired_subsriber_PSM1,
    //get_state_joint_desired_subsriber_PSM2;
...
//  clients will need to refer to this name to connect with this server
{
    ...
    PSMstates.first = "DVRK_UNINITIALIZED";
    PSMstates.second = "DVRK_UNINITIALIZED";
...
/*
        ...
        cout << "robot_state_PSM1: " << PSMstates_current.first << endl;
        cout << "robot_state_PSM2: " << PSMstates_current.second << endl;
...
int main(int argc, char** argv) {
    ...
    */
    ...
    //as.PSMstates.first = "DVRK_UNINITIALIZED";
    //as.PSMstates.second = "DVRK_UNINITIALIZED";

    pair<string, string> PSMstates_current = as.get_robot_state();
    ...
    */
    ...
    //main loop:
    PSMstates_current = as.get_robot_state();
