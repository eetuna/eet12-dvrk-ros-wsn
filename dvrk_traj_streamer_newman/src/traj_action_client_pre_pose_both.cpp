...
int main(int argc, char** argv) {
    ...
    des_trajectory.points.push_back(trajectory_point3);     
        ...
        int max_tries = 0;
        while (!server_exists) {
           server_exists = action_client.waitForServer(ros::Duration(25.0)); // wait for up to 5 seconds
        ...
        bool finished_before_timeout = action_client.waitForResult(ros::Duration(25.0));
